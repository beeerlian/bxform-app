...
const RemoveQuestion: React.FC<RemoveQuestionProps> = ({ onSuccess,onCancel ,questionId }) => {
  const [removeQ, { data: removeQData, loading: removeQLoading, error: removeQError }] = useMutation(QUESTION.deleteQuestion);
    ...
    <div className="mx-auto p-4">
          ...
          <div className="mt-6 flex justify-center space-x-2 ">
            <button
              ...
              className={`flex-1 px-4 py-2 bg-blue-500 text-white rounded ${removeQLoading ? 'opacity-50' : ''}`}
            >
            ...
            <button
              ...
              onClick={onDelete}
              disabled={removeQLoading}
              className={`flex-1 px-4 py-2 bg-red-500 text-white rounded ${removeQLoading ? 'opacity-50' : ''}`}
            >
